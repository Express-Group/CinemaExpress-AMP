...
<html amp>
	<meta charset="utf-8">
	<title><?php echo strip_tags($contentDetails['title']); ?> | Cinemaexpress</title>
	...
	<meta name="twitter:site" content="CinemaExpress" />
	<meta name="twitter:creator" content="@cinemaexpress.com" />
	...
	<script type="application/ld+json">
			{
				...
				"headline": "<?php echo strip_tags($contentDetails['title']); ?>",
	...
	<style amp-custom>
		@font-face{ font-family: fjord; src: url(<?php echo image_url ?>css/FrontEnd/fonts/FjordOne-Regular.ttf);}
		body{font-family: fjord;}
		header{float:left;width:100%;padding:2% 2% 0;background:#D6173A;}
		header .menu-bar{font-size: 31px;color: #fff;float: left;margin-left: 2%;}
		header .logo_img{float: left;margin-left: 20%;}
		nav{float:left;width:96%;overflow-x:scroll;padding: 2%;display:flex;flex:1;display:flex;border-bottom: 2px solid #DE1409;border-top: 2px solid #DE1409;font-family: fjord; }
		nav a{float: left;margin-right: 15px;font-size: 17px;text-decoration: none;color: #DE1409;flex: 0 0 auto;position: relative;font-weight: 700;text-transform: uppercase;}
		section{width: 96%;float: left;padding: 2%;}
		.section-name{float: left;margin: 6px 0 8px;background: #000;color: #fff;padding: 1px 7px 1px;font-size: 14px;    border-radius: 8px;}
		.article-title{float: left;margin:0 0 5px;width: 100%;}
		...
		.article-content{width: 100%;float: left;font-family: fjord;line-height: 1.7;font-size: 16px;text-align: justify;}
		.tags{float:left;width:100%;margin-bottom: 10px;}
		.tags span{float:left;margin-right: 10px;}
		.tags a{margin: 0px 6px 6px;text-decoration: none;background: #DE1409;color: #fff;padding: 1px 5px 2px;border-radius: 5px;float:left;}
		...
		.more-stories{float: left;width: 100%;flex: 1;display: flex;overflow-x: scroll;padding: 15px 0 15px;border-top: 2px solid #DE1409;border-bottom: 2px solid #DE1409;}
		...
		footer{float: left;width: 96%;padding: 2%;background: #333;color: #DE1409;margin-top: 3%;}
	...
	<body>
		...
		<div style="max-width: 600px; margin: 0 auto">
			<header>
				...
				<a href="<?php echo BASEURL; ?>" class="logo_img"><amp-img src="<?php echo image_url.'images/FrontEnd/images/cx_mlogo.png'; ?>" alt="" height="38" width="124"></amp-img></a>
				<div class="social-icons-n">
					<a target="_blank" href="https://www.facebook.com/XpressCinema"><amp-img src="<?php echo image_url.'images/amp-icons/facebook-is1.png'; ?>" alt="" height="24" width="24"></amp-img></a>
					<a target="_blank" href="https://twitter.com/XpressCinema"><amp-img src="<?php echo image_url.'images/amp-icons/twitter-is.png'; ?>" alt="" height="24" width="24"></amp-img></a>
					<a target="_blank" href="https://www.instagram.com/xpresscinema/"><amp-img src="<?php echo image_url.'images/amp-icons/instagram-is.png'; ?>" alt="" height="24" width="24"></amp-img></a>
				</div>
			</header>
			<nav>
				<?php
			...
			<section>
				...
				<div class="article-content">
					<?php
						...
						if($contentDetails['content_id']==1449){
							$content =stripslashes(strip_tags($contentDetails['title'], '</p>'));
						}
						...
						echo $finalcontent;
						if($contentType==2){
							if($contentDetails['review']!=0 || $contentDetails['review'] >5){
								$review=[];
								...
								echo '<span>Rating:</span>';
									echo $review[$contentDetails['review']];
								echo '</div>';
				...
				?>
				<amp-ad width=1 height=1 type="doubleclick" data-slot="/3167926/CE_AMP_Interstitial_1x1"></amp-ad>
				...
				<amp-sticky-ad layout="nodisplay">
					<amp-ad width="300" height="50" type="doubleclick" data-slot="/3167926/CE_AMP_Sticky_320x50"   rtc-config='{"vendors": { "aps": {"PUB_ID": "600", "PUB_UUID": "c3703fef-358e-4353-a111-eb049ab39167", "PARAMS":{"amp":"1"}} }}'></amp-ad>
				</amp-sticky-ad>
			</section>
			<footer>
